function MainCtrl($window,$rootScope,$scope,$http) {

    // var url_now = $window.location.href.toString().split($window.location.host)[1];

    // if(sessionStorage.id != null && url_now == "/spps/#/login"){
    //     $window.location.href = "/spps/#/dashboards";
    // }

    // if(sessionStorage.id == null){
    //     $window.location.href = "/spps/#/login";
    // }
    // else{
    //     $rootScope.session_id = sessionStorage.id;
